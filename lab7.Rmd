...
For each district, you can count the number of tornadoes that touched down within the district's boundaries in the last 20 years. School districts with fire stations near by may be better positioned to deal with the damage of a tornado, so you can adjust by some factor related to fire station distance to determine risk.
